...
public class GeneratorVO implements Serializable {
    ...
    public static Generator voToObj(GeneratorVO generatorVO) {
        ...
        generator.setFileConfig(fileConfig == null ? null : JSONUtil.toJsonStr(fileConfig));
        Meta.ModelConfig modelConfig = generatorVO.getModelConfig();
        generator.setModelConfig(modelConfig == null ? null : JSONUtil.toJsonStr(modelConfig));
        return generator;
    }
